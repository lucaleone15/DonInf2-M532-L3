...
public class WorldMapLocationGenerator {
    ...
    public void generateWorldMapLocation(Location[][] map) {
        ...
        map[0][1] = new Location("Cursed Square", "A fog-covered square. Whispers echo in the mist.", false, new Letter("torn letter", "More you take, more you leave behind."), null);
        ...
        map[1][2] = new Location("Chapel", "An abandoned chapel entangled in thorns.", false, new Letter("faded note", "I speak without a mouth and hear without ears..."), null);
        map[1][3] = new Location("Cave", "A damp cave with ancient carvings.", false, null, null);

        map[2][0] = new Location("Ruins", "Ancient ruins with strange symbols.", false, new Letter("stone tablet", "What has keys but can't open locks?"), null);
        ...
        map[3][0] = new Location("Lake", "A serene lake with something glimmering beneath.", false, new Letter("wet scroll", "I have cities, but no houses. I have mountains, but no trees..."), null);
